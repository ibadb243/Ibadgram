...
namespace Tests.Chats
{
    public class UpdateShortnameCommandHandlerTests
    {
        ...
        private Mock<ILogger<UpdateShortnameCommandHandler>> _loggerMock;
        private UpdateShortnameCommandHandler _handler;
        ...
        [Fact]
        public async Task Handle_ValidCommand_UpdatesShortnameSuccessfully()
        {
            // Arrange
            ...
            _mentionRepositoryMock.Verify(m => m.UpdateAsync(It.Is<ChatMention>(m => m.Shortname == command.Shortname && m.ChatId == groupId), It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task Handle_UserNotFound_ReturnsFailure()
        {
            ...
            _mentionRepositoryMock.Verify(m => m.UpdateAsync(It.IsAny<ChatMention>(), It.IsAny<CancellationToken>()), Times.Never);
        }
        ...
        [Fact]
        public async Task Handle_GroupIsPrivate_ReturnsFailure()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var groupId = Guid.NewGuid();
        ...
        public async Task Handle_DatabaseError_RollsBackTransaction()
        {
            ...
            _unitOfWorkMock.Setup(u => u.BeginTransactionAsync(It.IsAny<CancellationToken>()))
                .Returns(Task.CompletedTask);
            _mentionRepositoryMock.Setup(m => m.UpdateAsync(It.IsAny<ChatMention>(), It.IsAny<CancellationToken>()))

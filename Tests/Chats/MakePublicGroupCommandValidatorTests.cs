...
{
    public class MakePublicGroupCommandValidatorTests
    {
        private MakePublicGroupCommandValidator _validator;

        public MakePublicGroupCommandValidatorTests()
        {
            _validator = new MakePublicGroupCommandValidator();
        }
